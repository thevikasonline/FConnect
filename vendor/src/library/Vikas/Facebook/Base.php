<?php
namespace Vikas\Facebook;

use Vikas\Facebook\ApiException as FacebookApiException;
...
abstract class Base {
     ...
     */
    public function getLoginUrl ($params = array(), $mobile = false) {
        ...
        if ($mobile) {
            return $this->getUrl(
                            'mobile', 'dialog/oauth', array_merge(array(
                        'client_id' => $this->getAppId(),
